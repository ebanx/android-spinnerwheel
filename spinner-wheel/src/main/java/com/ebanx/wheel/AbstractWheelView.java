...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    private static final String LOG_TAG = AbstractWheelView.class.getName() + " #" + (++itemID);
    ...
    // the rest
    /** Passive coeff */
    protected float mPassiveCoeff;
    /** Active coeff */
    protected float mActiveCoeff;
    /**
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mPassiveCoeff = a.getFloat(R.styleable.AbstractWheelView_passiveCoef, 0f);
        a.recycle();
    }
