...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    /** Default text color */
    public static final int DEFAULT_SELECTED_TEXT_COLOR = 0xFF101010;
    /** Default text color */
    public static final int LABEL_COLOR = 0xFF700070;
    public static final int DEFAULT_TEXT_ALIGN = View.TEXT_ALIGNMENT_TEXT_START;
    /** Default text size */
...
//                ColorAnimator.ofColor(textView, "textColor", textColor,selectedTextColor).start();
            } else {
            ...
            textView.setLines(1);
            textView.setTextAlignment(DEFAULT_TEXT_ALIGN);
