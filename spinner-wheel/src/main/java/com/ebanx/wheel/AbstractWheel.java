...
import com.ebanx.wheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
    ...
    private static final String LOG_TAG = AbstractWheel.class.getName() + " #" + (++itemID);
    // Recycle
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mTextColor = a.getColor(R.styleable.AbstractWheelView_defaultTextColor, Color.LTGRAY);
        mSelectedTextColor = a.getColor(R.styleable.AbstractWheelView_selectedTextColor, Color.BLACK);
    ...
    protected void init() {
        ...
        mScroller = createScroller(new WheelScrollingListener(this));
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        AbstractWheelSavedState ss = new AbstractWheelSavedState(superState);
        //end
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (!(state instanceof AbstractWheelSavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        final AbstractWheelSavedState ss = (AbstractWheelSavedState) state;
    ...
    protected abstract void recreateAssets(int width, int height);
    ...
    protected abstract void onScrollTouched();

    protected abstract void onScrollTouchedUp();
     ...
     * @param friction the getAmount of friction
     */
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (changed) {
            ...
            if (mLayoutWidth != w || mLayoutHeight != h) {
                recreateAssets(this.getMeasuredWidth(), this.getMeasuredHeight());
            }
            mLayoutWidth = w;
            mLayoutHeight = h;
        }
     ...
     * Actual getAmount of visible items depends on spinnerwheel layout parameters.
    ...
    public void setViewAdapter(WheelViewAdapter viewAdapter) {
        ...
        this.mViewAdapter.setTextColor(mTextColor);
        this.mViewAdapter.setSelectedTextColor(mSelectedTextColor);
    ...
    private void calculatVisibleItems() {
        if (mIsAllVisible) {
            int baseDimension = getBaseDimension();
            int itemDimension = getItemDimension();
            if (itemDimension != 0) {
